...
@section('content')
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><small>Add new newsletter </small></h1>
            </div>
        </div><!--/.row-->
        <div class="row">
            <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                        Picture : <input type="file" name="txtimg" accept="image/*" id="inputtxtimg" value="{{ old('txtimg') }}" class="form-control" required="required">
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        Information resource : <input type="text" name="txtSource" id="inputtxtSource" value="{{ old('txtSource') }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
