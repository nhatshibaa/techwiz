...
@section('content')
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><small>Edit Product </small></h1>
            </div>
        </div><!--/.row-->
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body" style="background-color: #ecf0f1; color:#27ae60;">
                        ...
                        <form action="" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="input-id">ID of the catalog</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="inputTxtname" required="" class="form-control"
                                       value="{{$edit->name}}">
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                        Hình ảnh : <input type="file" name="image" accept="image/png" id="inputtxtimg"
                                                          class="form-control">
                                        Ảnh cũ: <img src="{!!url('frontend/image/product/'.$edit->image)!!}"
                                                     alt="{!!$edit->image!!}" width="80" height="60">
                                    </div>
                                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                        Giá bán : <input type="number" name="unit_price" id="inputtxtprice"
                                                         class="form-control" value="{{$edit->unit_price}}"
                                                         required="required">
                                    </div>
                                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                        Giá khuyễn mãi : <input type="number" name="promo_price" id="inputtag"
                                                                value="{{$edit->promotion_price}}" required=""
                                                                class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <textarea name="description" id="inputtxtReview" class="form-control" rows="4"
                            ...
                            <input type="submit" name="btnCateEdit" class="btn btn-primary" value="Edit product"
                                   class="button"/>
                        </form>
                    </div>
                </div>
